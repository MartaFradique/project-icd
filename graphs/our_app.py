...
#     pastel_colors = plt.cm.get_cmap('Pastel1', len(top_10_data))
#     bars = ax.barh(top_10_data['Country'], top_10_data['Document Count'], color=pastel_colors.colors, height=0.4)  # Adjust bar height for thin bars

#     # Display the values on top of each bar
#     for i, val in enumerate(top_10_data['Document Count']):
